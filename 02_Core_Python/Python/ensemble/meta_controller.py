...
class MetaController:
    ...
    def decide(
        ...
        if no_trade_reasons:
            ...
            # Delegate to DecisionBuilder for non-strong cases
        ...
        # Build TradeIntent for trade actions (single pass — no second build_intent call)
        intent: Optional[TradeIntent] = None
        if final_action in ("LONG", "SHORT"):
            ...
            if intent:
                # Apply meta-controller sizing on top of DecisionBuilder output
